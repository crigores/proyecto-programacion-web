...
function agregarUsuario($nombre, $apellido, $cedula, $direc, $tlf, $clave){
    $bd = obtenerConexion();
    $sentencia = $bd->prepare("INSERT INTO usuarios (nombre, apellido, cedula, direc, tlf, clave) VALUES(?,?,?,?,?,?)");
    return $sentencia->execute([$nombre, $apellido, $cedula, $direc, $tlf, $clave]);
}